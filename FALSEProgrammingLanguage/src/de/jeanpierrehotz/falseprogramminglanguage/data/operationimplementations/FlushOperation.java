...
public class FlushOperation extends Operation {
    ...
    public static final byte OPERATION_BYTE = 43;

    public FlushOperation(int index) {
        super(index);
    }
    ...
    public String toString() {
        return "" + FalseLanguageDefinition.FLUSH_STREAM_OPERATOR;
    }
}
