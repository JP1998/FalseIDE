 ...
 */
public class CharacterValueOperation extends Operation {

    public static final byte OPERATION_BYTE = 10;

    private char value;

    public CharacterValueOperation(int index, char value) {
        super(index);
        this.value = value;
    }
    ...
    public Byte[] toByteArray() {
        ...
        bb.putChar(value).position(0);

        returnValue[1] = bb.get();
        returnValue[2] = bb.get();
