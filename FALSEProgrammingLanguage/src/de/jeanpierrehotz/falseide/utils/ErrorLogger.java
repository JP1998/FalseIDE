...
//          log every line with an timestamp in front of it
            logContent += new SimpleDateFormat(Ressources.ERROR_LOGGER_PREFIX).format(Calendar.getInstance().getTime()) + message + "\n";
        }
...
//      log the class name of the Throwable object
        String logText = new SimpleDateFormat(Ressources.ERROR_LOGGER_PREFIX).format(Calendar.getInstance().getTime()) + t.getClass().toString();
...
//          log that there is a message we need to show
            logText += "\n" + new SimpleDateFormat(Ressources.ERROR_LOGGER_PREFIX).format(Calendar.getInstance().getTime()) + Ressources.ERROR_LOGGER_STACKTRACE_MESSAGE_INTRO;

//          and log every line of the message
            for(String line: messageLines){
                logText += "\n" + new SimpleDateFormat(Ressources.ERROR_LOGGER_PREFIX).format(Calendar.getInstance().getTime()) + Ressources.ERROR_LOGGER_STACKTRACE_MESSAGE_PREFIX + line;
            }
        }

//      then we'll log the stacktrace
        for(StackTraceElement element : t.getStackTrace()){
            logText += "\n" + new SimpleDateFormat(Ressources.ERROR_LOGGER_PREFIX).format(Calendar.getInstance().getTime()) + Ressources.ERROR_LOGGER_STACKTRACE_PREFIX + element.toString();
        }
